  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center gap-6 p-6">
      ...
      <div className="w-full max-w-sm space-y-3">
        <button onClick={()=>nav('/home')} className="btn btn-outline w-full">Continuar con Google</button>
        <button onClick={()=>nav('/login')} className="btn btn-outline w-full">Continuar con Email</button>
      </div>
    </div>
  )
}
