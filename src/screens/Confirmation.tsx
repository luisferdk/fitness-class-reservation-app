...
export default function Confirmation(){
  ...
  return (
    <div className="min-h-screen p-6 flex flex-col items-center">
      ...
      <p className="text-center text-gray-600 mt-2">Tu clase de está confirmada.<br/>¡A darlo todo!</p>
      ...
      <button onClick={()=>nav('/home')} className="btn btn-primary w-full mt-10">Volver al inicio</button>
    </div>
  )
}
